...
function SimulateReplicatedProjectile(Tool, Handle, VMHandle, CLDirections, SVDirections, FirePointObject, MuzzlePointObject, Misc, Replicate)
	ProjectileHandler:SimulateProjectile(Tool, Handle, VMHandle, CLDirections, SVDirections, FirePointObject, MuzzlePointObject, Misc, Replicate)
end
...
function Charge(EffectName, State, Character, Viewmodel, Tool, Handle, ChargeLevel, Replicate)
	...
	if State == "Begin" then
		Effect:BeginCharge(Character, Viewmodel, Tool, Handle, ChargeLevel)
	elseif State == "End" then
		Effect:EndCharge(Character, Viewmodel, Tool, Handle)
	end
	if Replicate then
...
function Overheat(EffectName, State, Character, Viewmodel, Tool, Handle, Replicate)
	if EffectName == "None" then
		return
	end
	...
	if State == "Begin" then
		Effect:BeginOverheat(Character, Viewmodel, Tool, Handle)
	elseif State == "End" then
		Effect:EndOverheat(Character, Viewmodel, Tool, Handle)
	end
	if Replicate then
...
VisualizeBullet.OnClientEvent:Connect(function(Tool, Handle, Directions, FirePointObject, MuzzlePointObject, Misc)
	SimulateReplicatedProjectile(Tool, Handle, nil, nil, Directions, FirePointObject, MuzzlePointObject, Misc)
end)
...
VisualizeCharge.OnClientEvent:Connect(function(EffectName, State, Character, Tool, Handle, ChargeLevel)
	Charge(EffectName, State, Character, nil, Tool, Handle, ChargeLevel)
end)
VisualizeOverheat.OnClientEvent:Connect(function(EffectName, State, Character, Tool, Handle)
	Overheat(EffectName, State, Character, nil, Tool, Handle)
end)
